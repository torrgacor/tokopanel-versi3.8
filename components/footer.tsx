        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/beli-adp" className="text-gray-400 hover:text-red-500 transition-colors">
                  Admin Panel
                </Link>
              </li>
              <li>
                <Link href="/history" className="text-gray-400 hover:text-red-500 transition-colors">
                  Riwayat Transaksi
                </Link>
              </li>
              <li>
                <Link href="/garansi" className="text-gray-400 hover:text-red-500 transition-colors">
                  Claim Garansi
                </Link>
              </li>
              <li>
                <Link href="/affiliate" className="text-gray-400 hover:text-red-500 transition-colors">
                  Jadi Affiliator
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-1">
            <h3 className="text-lg font-semibold text-white mb-4">SALURAN</h3>
            <ul className="space-y-2">
              <li>
                <Link href={appConfig.socialMedia.channelWa} className="text-gray-400 hover:text-red-500 transition-colors">
                  Informasi Website & Server
                </Link>
              </li>
              <li>
                <Link href={appConfig.socialMedia.channelTele} className="text-gray-400 hover:text-red-500 transition-colors">
                  Semua Riwayat Transaksi
                </Link>
              </li>
              <li>
                <Link href={appConfig.socialMedia.channelWaDMP} className="text-gray-400 hover:text-red-500 transition-colors">
                  Digital Marketplace
                </Link>
              </li>
            </ul>
