...
const faqs = [
  ...
  {
  question: "Apa perbedaan antara paket Normal dan Express?",
  answer: "Normal menggunakan CPU yang terbatas dan Kapasitas yang terbatas, Sedangkan paket Paket Express menggunakan CPU Unlimited (tidak terbatas).",
  },
  {
  question: "Apa Fungsi Dari CPU Panel?",
  answer: "Manajemen alokasi dan pembatasan sumber daya komputasi fisik server (node) agar setiap panel server berjalan lancar dan tidak mengganggu satu sama lain.",
  },
  {
