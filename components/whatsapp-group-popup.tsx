        ...
        >
          <div className="bg-green-900/20 p-5">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-lg font-medium text-white">Gabung Saluran WhatsApp</h3>
              </div>
              <button
                onClick={handleClose}
          ...
          <div className="p-5">
            <p className="mb-4 text-gray-300">
              Bergabunglah dengan Saluran WhatsApp kami untuk mendapatkan Informasi terbaru, dukungan, dan tips seputar
